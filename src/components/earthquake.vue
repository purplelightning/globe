...
export default {
  ...
  methods: {
    initData() {
      let dom = document.querySelector("#ee");
    ...
    const myGlobe = Globe()(dom)
      ...
      fetch('http://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/2.5_month.geojson').then(res => res.json()).then(equakes => {
